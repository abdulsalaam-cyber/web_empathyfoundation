...
document.addEventListener("DOMContentLoaded", function () {
	...
	if (registerForm) {
		registerForm.addEventListener("submit", function (event) {
			...
			// Delay redirect for smooth effect
			setTimeout(function () {
...
document.getElementById("donationForm").addEventListener("submit", async function (event) {
	...
	let donationData = { name, phone, amount };

	try {
		let response = await fetch("process_donation.php", {
			method: "POST",
			headers: {
		...
		if (result.success) {
			...
			messageEl.innerText = "Donation request sent! Check your phone to approve the payment.";
		} else {
